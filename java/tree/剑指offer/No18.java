public class No18 {
    ...
    private static boolean doseTree1HavaTree2(BinaryTreeNode root1, BinaryTreeNode root2) {
	if(root2 == null)
	    return true;
	if(root1 == null)
	    return false;
	...
	return doseTree1HaveTree2(root1.getLchildNode(), root2.getLchildNode()) && doesTree1HaveTree2(root1.getRchildNode(),root2.getRchildNode());
    }
}
